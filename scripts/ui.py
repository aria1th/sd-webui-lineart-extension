        ...
        with gr.Row():
            with gr.Tabs():
                with gr.TabItem("PNG2APNG"):
                    ...
                    def convert_image(image:Image.Image, threshold:float, upscale_scale:float, adaptive:bool)->np.ndarray:
                        """
                    ...
                    button.click(convert_image, inputs=[image_upload_input, threshold_input, upscale_input, adaptive_checkbox], outputs=[image_upload_output])
